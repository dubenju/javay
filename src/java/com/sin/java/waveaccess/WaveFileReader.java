...
public class WaveFileReader {
    ...
    private void initReader(String filename) {
        ...
        try {
            ...
            this.audioformat   = readInt(); // 编码方式，一般为0x0001
            this.numchannels   = readInt(); // 声道数目，1--单声道；2--双声道
            this.samplerate    = readLong(); // 采样频率
            this.byterate      = readLong(); // 每秒所需字节数
            ...
            System.out.println("Data Chunk Size=" + this.subchunk2size);

            System.out.println("声道数numchannels=" + this.numchannels);
            System.out.println("每个采样需要的bit数(bitspersample)=" + this.bitspersample);

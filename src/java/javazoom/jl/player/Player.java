...
public class Player
{
	...
	public boolean play(int frames) throws JavaLayerException {
		...
		System.out.println(Player.class.getName() + "\t\tplay:" + (ed - st) / 1000000 + "ms.ret=" + ret);
		...
		System.out.println(Player.class.getName() + "\t\tplay:" + (ed2 - ed) / 1000000 + "ms.ret=" + ret);
		return ret;
	}
...
//			}
	...
	protected boolean decodeFrame() throws JavaLayerException {
		try {
			...
			long ed = System.nanoTime();
			System.out.println("解码耗时:" + (ed - st) / 1000000 + "ms");
			...
			ed = System.nanoTime();
			System.out.println("播放耗时:" + (ed - st) / 1000000 + "ms");
